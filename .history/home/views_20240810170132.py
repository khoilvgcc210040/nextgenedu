...
def authPage(request):
    ...
    if request.method == 'POST':
        ...
        if form_type == 'signup':
            ...
            if errors:
                request.session['signup_data'] = {
                    ...
                    'grade': grade,
                    'terms': terms,
                    'show_signup_errors': show_signup_errors,
                }
        ...
        print(signup_data.get('show_signup_errors', ''))
        context = {
            'form_type': form_type,
            ...
            'months': months,
            'years': years,
            'show_signup_errors': signup_data.get('show_signup_errors', ''),
            'show_login_errors': show_login_errors,
