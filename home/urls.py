...
urlpatterns = [
    ...
    path('achivement/<int:user_id>/', views.achivement, name='achivement'),
    ...
    path('edit_submission_duration/', views.edit_submission_duration, name='edit_submission_duration'),
    path('verify-otp/', views.verify_otp, name='verify_otp'),
    path('resend-otp/', views.resend_otp, name='resend_otp'),
    path('verify-email-otp/', views.verify_email_otp, name='verify_email_otp'),
    path('resend-email-otp/', views.resend_email_otp, name='resend_email_otp'),
    path('toggle_like/<int:post_id>/', views.toggle_like, name='toggle_like'),
    path('request_co_teacher/<int:classroom_id>/', views.request_co_teacher, name='request_co_teacher'),
    path('handle_co_teacher_request/', views.handle_co_teacher_request, name='handle_co_teacher_request'),
    path('save_remaining_time/', views.save_remaining_time, name='save_remaining_time'),
    path('delete_quiz_result/<int:quiz_result_id>/', views.delete_quiz_result, name='delete_quiz_result'),
    ...
    path('get-unread-notification-count/', views.get_unread_notification_count, name='get_unread_notification_count'),
    path('delete-all-notifications/', views.delete_all_notifications, name='delete_all_notifications'),
    path('create-account-admin/', views.create_account_admin, name='create_account_admin'),
    ...
    path('delete_subsection_file/<int:subsection_file_id>/', views.delete_subsection_file, name='delete_subsection_file'),
    path('delete_submission_file/<int:submission_file_id>/', views.delete_submission_file, name='delete_submission_file'),
    path('delete_post_forum/<int:post_forum_id>/', views.delete_post_forum, name='delete_post_forum'),
